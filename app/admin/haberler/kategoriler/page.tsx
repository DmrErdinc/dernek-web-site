...
export default function HaberKategorilerPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Haber Kategorileri</h1>
          <p className="text-gray-600 mt-2">Haber kategorilerini yönetin</p>
        </div>
        <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Duyurular, Etkinlikler vb."
                required
              />
            </div>
